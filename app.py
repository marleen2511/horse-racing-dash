...
df = pd.read_csv('C:/Users/marleen/OneDrive/Projecten/Horse Racing/data/nyra_tracking_table.csv')
df_start = pd.read_csv('C:/Users/marleen/OneDrive/Projecten/Horse Racing/data/nyra_start_table.csv')
